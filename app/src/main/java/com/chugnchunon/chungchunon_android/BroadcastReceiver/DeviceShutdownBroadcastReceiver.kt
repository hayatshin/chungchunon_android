...
import com.chugnchunon.chungchunon_android.Service.MyService.Companion.stepCountSharedPref
...
class DeviceShutdownBroadcastReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intentAction == Intent.ACTION_SHUTDOWN || intentAction == Intent.ACTION_REBOOT) {
